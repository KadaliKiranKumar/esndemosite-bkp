...
frs_slider_lock();var imgWidth=[],imgHeight=[],imgCount=0;$(slideWrapper.children()).imagesLoaded().progress(function(instance,image){if($(image.img).parent().attr('class')=='frs-slide-img')
