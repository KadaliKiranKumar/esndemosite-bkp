     ...
     <div class="top_nav">
                <div class="container">
					...
					<ul class="topsocial">
							...
							<li><a href="https://www.linkedin.com/company/esn-technologies"><i class="fa fa-linkedin"></i></a></li>
                            <li><a href="https://twitter.com/everest_consinc"><i class="fa fa-twitter"></i></a></li>
